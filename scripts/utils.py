...
def expand_selection(protein_file, selection_out_file, chian_id, residue_num, distance=5, sanitize=True):
    # protein_file = r'G:\02ReData201904034\tencent20191106\protein_mutation\Data_S3_new\platinum_files\2IEN\I84V\mutant.pdb'
    # selection_out_file = r'C:\Users\15766\Desktop\mutant_sel.pdb'
    # chian_id = 'A,B'
    # residue_num = 84
    # distance = 5
    # sanitize = True
    ...
    # 如果ligand存在于蛋白结构中，选择的时候该ligand也会在selction里面
